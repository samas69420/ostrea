...
params = Params(# environment/general training parameters 
                ...
                N_EVAL_EPISODES = 3,             # how many episodes should be used for evaluation during training
                GAMMA = 0.99,
                N_ENV = 3,
                ...
                WARMUP = 1000,                   # warmup steps without any update
                MEMORY_MAXLEN = 50_000,
                ...
                NORMALIZE_OBSERVATIONS = True,   # normalize observation (linear scaling normalization)
                POLICY_METHOD = True,
                ALGO_NAME = "sac")
