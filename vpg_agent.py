...
class VPGAgent:
    ...
    """
    implementation of a reinforcement learning agent that uses VPG algorithm

    This implementation can be used in environments with both 
    continuous and discrete action spaces

    with continuous actions the policy network will predict
    the parameters (means and cov matrix) of the n-dimensional normal 
    distribution the n actions will be sampled from
